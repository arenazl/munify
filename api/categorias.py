...
async def get_categorias(
    ...
    query = select(Categoria).where(Categoria.municipio_id == current_user.municipio_id)
...
async def create_categoria(
    ...
    categoria = Categoria(**data.model_dump(), municipio_id=current_user.municipio_id)
    db.add(categoria)
    await db.commit()
