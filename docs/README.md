...
| [`handoffs/`](handoffs/) | Cierres de sesión por fecha (`YYYY-MM-DD_titulo.md`). Último: `2026-09-02_estado-y-pendientes.md` — el padrón de localidades con contorno (90% del país), cómo lo consume el alta de demos, mapa a pantalla completa y dónde vive /calls |
...
| **Retomar lo del 2026-09-02 (IA a Groq, login de /calls, telemetría, módulo Patrimonio)** | [`handoffs/2026-09-02_estado-y-pendientes.md`](handoffs/2026-09-02_estado-y-pendientes.md) — **el más nuevo**: nombres de las bases nuevas, el gotcha de gpt-oss que dejaba la IA muda, y qué quedó a medias (el pipeline compartido de /calls y la semilla de Patrimonio) |
