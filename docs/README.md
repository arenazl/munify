...
| [`handoffs/`](handoffs/) | Cierres de sesión por fecha (`YYYY-MM-DD_titulo.md`). Último: `2026-09-03_hoja-por-contencion.md` — qué barrio se dibuja y cuál queda de respaldo (`hoja`/`motivo_hoja`): las 4 variantes probadas, por qué ganó la contención por área, los números por país, y el bloqueo del Aiven read-only. Antes: `2026-09-03_zona-unica-y-catalogo-barrios.md` (la zona es del negocio, `catalogo_barrios`, la semilla que ya no fabrica geografía) y `2026-09-02_cartografia-offline-pbf.md` (la herramienta del PBF y `catalogo_geo_osm`) |
