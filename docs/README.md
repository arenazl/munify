...
| **Retomar zonas / barrios / polígonos del mapa (Zona única + `catalogo_barrios`)** | [`handoffs/2026-09-03_zona-unica-y-catalogo-barrios.md`](handoffs/2026-09-03_zona-unica-y-catalogo-barrios.md) — **el más nuevo**: la decisión (la zona es del negocio), cómo se llena el catálogo de barrios por provincia, qué hace la semilla ahora, la cobertura escrita, y lo primero a verificar (una demo nueva en QA) |
