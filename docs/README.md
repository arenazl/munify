...
| [`handoffs/`](handoffs/) | Cierres de sesión por fecha (`YYYY-MM-DD_titulo.md`). Último: `2026-09-02_cartografia-offline-pbf.md` — la cartografía de las demos curada OFFLINE desde el extracto de Geofabrik (los 6 países, todo municipio con contorno), la herramienta, qué le falta a prod y los huecos abiertos (contornos que no contienen su ciudad) |
...
| **Retomar la cartografía de las demos (barrios/calles reales, offline, todo el catálogo)** | [`handoffs/2026-09-02_cartografia-offline-pbf.md`](handoffs/2026-09-02_cartografia-offline-pbf.md) — **el más nuevo**: cómo se cura un país entero desde el `.osm.pbf` en minutos, la cobertura por país (6/6), qué tiene que repetir Infra al promover, y la etapa siguiente (polígonos de barrio, contornos que dejan la ciudad afuera) |
