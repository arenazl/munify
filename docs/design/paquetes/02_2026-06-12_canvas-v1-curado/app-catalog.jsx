...
const App = () => (
  <DesignCanvas>
    ...
    <DCSection
      id="banners-azul"
      title="Portadas de Facebook · serie azul (qué hace la app)"
      subtitle="Tres portadas en tono azul enfocadas en las funciones: los módulos, la trazabilidad del reclamo, y el valor en tiempo real."
    >
      <DCArtboard id="fb-modulos" label="D · Los 4 módulos" width={FB_W} height={FB_H}>
        <BannerModulos/>
      </DCArtboard>
      <DCArtboard id="fb-flujo" label="E · Trazabilidad / flujo" width={FB_W} height={FB_H}>
        <BannerFlujo/>
      </DCArtboard>
      <DCArtboard id="fb-tiemporeal" label="F · En tiempo real" width={FB_W} height={FB_H}>
        <BannerTiempoReal/>
      </DCArtboard>
    </DCSection>
    ...
    <DCSection
      id="banners-web"
      title="Portadas de Facebook · fuente del sitio (serif Newsreader)"
      subtitle="Tres variantes con la tipografía serif del sitio web y el mensaje oficial resumido."
    >
      <DCArtboard id="fb-web-hero" label="G · Hero (espejo del sitio)" width={FB_W} height={FB_H}>
        <BannerWebHero/>
      </DCArtboard>
      <DCArtboard id="fb-web-serv" label="H · Servicios" width={FB_W} height={FB_H}>
        <BannerWebServicios/>
      </DCArtboard>
      <DCArtboard id="fb-web-ia" label="I · Tiempo real / IA" width={FB_W} height={FB_H}>
        <BannerWebIA/>
      </DCArtboard>
    </DCSection>
  </DesignCanvas>
