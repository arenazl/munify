...
const SUSCRIPCIONES_DEMO: SuscripcionRow[] = [
  { id: 1, alias: 'San Pedro Norte',  codigo: 'sanpedro-n', plan: 'Express',  estado: 'activo',  altaIso: '2025-08-12', proximaFacturaIso: '2026-06-12', montoMensual: 180000 },
  { id: 2, alias: 'Villa del Lago',   codigo: 'villalago',  plan: 'Premium',  estado: 'activo',  altaIso: '2025-06-03', proximaFacturaIso: '2026-06-03', montoMensual: 320000 },
  ...
  { id: 4, alias: 'Costa Brava',      codigo: 'costabrava', plan: 'Express',  estado: 'activo',  altaIso: '2025-11-09', proximaFacturaIso: '2026-06-09', montoMensual: 180000 },
  { id: 5, alias: 'Sierra Chica',     codigo: 'sierra-c',   plan: 'Estandar', estado: 'activo',  altaIso: '2025-10-01', proximaFacturaIso: '2026-06-01', montoMensual: 95000 },
  { id: 6, alias: 'Puerto Esperanza', codigo: 'pto-esp',    plan: 'Premium',  estado: 'vencido', altaIso: '2025-03-15', proximaFacturaIso: '2026-05-15', montoMensual: 320000 },
];
