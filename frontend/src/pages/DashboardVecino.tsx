...
export default function DashboardVecino() {
  ...
  const fetchData = async () => {
    try {
      const [reclamosRes, publicasRes, configRes] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 rounded-xl font-medium transition-all active:scale-95 touch-manipulation"
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-xl sm:text-2xl font-bold" style={{ color: theme.text }}>
        {value}
      </p>
