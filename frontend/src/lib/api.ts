...
export const comprasApi = {
  ...
  getOne: (id: number) => api.get(`/compras/${id}`),
  create: (data: Record<string, unknown>) => api.post('/compras', data),
  update: (id: number, data: Record<string, unknown>) => api.put(`/compras/${id}`, data),
